        ...
        <section className="relative py-24 md:py-32 border-t border-border">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <motion.div
                    ...
                    className="mt-16 rounded-lg overflow-hidden border border-border bg-muted/30 dark:bg-[#131316]"
                >
                    ...
                    <pre className="px-5 py-5 text-sm font-mono overflow-x-auto leading-relaxed">
                        <code>
                            ...
                            <span className="text-primary font-medium">curl</span>
                            <span className="text-foreground"> https://api.silkdock.ai/v1/chat/completions \</span>
                            {"\n  "}
                            <span className="text-foreground">-H </span>
                            <span className="text-emerald-600 dark:text-emerald-400">&quot;Authorization: Bearer sk-your-key&quot;</span>
                            ...
                            <span className="text-emerald-600 dark:text-emerald-400">&apos;{`{"model":"gpt-5","messages":[{"role":"user","content":"Hello!"}]}`}&apos;</span>
                        </code>
                    </pre>
                </motion.div>
            </div>
